...
// opens Sonic game frame and its components
public class MazeRaceGUISonic extends JFrame implements KeyListener, ActionListener {
	...
	// load object images
	private final ImageIcon WALL = new ImageIcon("images/blue square.png");
	...
	// constructor method
	public MazeRaceGUISonic(Player player) {
